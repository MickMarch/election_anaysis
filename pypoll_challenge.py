...
highest_turnout_county_vote_count = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if votes > highest_turnout_county_vote_count:
            highest_turnout_county = county_name
            highest_turnout_county_vote_count = votes

    highest_turnout_county_summary = (
        f"\n-------------------------\n"
        f"Largest Turnout County: {highest_turnout_county}\n"
        f"-------------------------\n"
    )
